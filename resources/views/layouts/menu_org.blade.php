...
{{ Request::is('anioLectivos*') ? 'active' : 
   ...
   '' }}" <?PHP echo $gm_conf ?> >
    <a href="#">
        <i class="glyphicon glyphicon-cog text-danger"></i> <span>Configuraciones</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
...
'' }}" <?PHP echo $gm_mat ?>  >
    <a href="#">
        <i class="fa fa-book text-danger"></i> <span>Materias</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul class="treeview-menu">
...
<li class="treeview {{ Request::is('estudiantes*') ? 'active' : 
    ...
    <a href="#">
        <i class="glyphicon glyphicon-user text-danger"></i> <span>Matriculas</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul class="treeview-menu">
...
<li class="treeview {{ Request::is('reportes*') ? 'active' : 
    ...
    <a href="#">
        <i class="glyphicon glyphicon-file text-danger"></i> <span>Reportes</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('regNotas*') ? 'active' : 
                       ...
                       '' }}" <?PHP echo $gm_notas ?>  >
    <a href="#">
        <i class="glyphicon glyphicon-list-alt text-danger"></i> <span>Notas</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('asistencias*') ? 'active' : '' }} " <?PHP echo $gm_asist ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Inspeccion</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ 
   ...
   Request::is('pagoManualPensiones*') ? 'active': ''
    ...
    <a href="#">
        <i class="fa fa-money text-danger" aria-hidden="true"></i><span>Pensiones</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('rubros*') ? 'active' : '' }} " <?PHP echo $gm_rubros ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Rubros</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('rubros*') ? 'active' : '' }} " <?PHP echo $gm_rrhh ?>  >
    <a href="#">
        <i class="fa fa-user text-danger" aria-hidden="true"></i><span>RRHH</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} " <?PHP echo $gm_sistema ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Sistema</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} " <?PHP echo $gm_dece ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>DECE</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} " <?PHP echo $gm_capellania ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Capellania</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{
   ...
   Request::is('erpDivisions*') ? 'active': ''
    ...
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Bodegas</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} " <?PHP //echo $gm_comunicaciones ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Comunicaciones</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} " <?PHP echo $gm_encuestas ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Encuestas</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview {{ Request::is('auditorias*') ? 'active' : '' }} "  ?>  >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Aula Virtual</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
...
<li class="treeview    
    ...
    "  <?php echo "" ?> >
    <a href="#">
        <i class="fa fa-clock-o text-danger" aria-hidden="true"></i><span>Productos y Servicios</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    <ul  class="treeview-menu">
