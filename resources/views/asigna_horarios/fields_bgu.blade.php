<script>
    $(function(){
        var per_id="<?php echo Session::get('periodo_id')?>";
        $("select[name=anl_id]").val(per_id);
    })
</script>
<!-- Usu Id Field -->
...
<div class="form-group col-sm-12" >
    <table class="table">
        ...
        <tr>
            <td hidden>
                {!! Form::select('esp_id',['7'=>'BGU-ACELERADO'],null,['class' => 'form-control']) !!}                
            </td>
            <td>
                {!! Form::select('anl_id', $periodos,null, ['class' => 'form-control']) !!}
            </td>
