...
<body>
    ...
    <div id="header_principal">
            ...
            <h4 style="text-align:center;margin-top:-12px ">CUADROS DEL {{$quim_text}}</h4>
            @if($cur<4)
               <h5>
                  ...
                  <span style="float:right; ">
                     Paralelo:'{{$conf['paralelo']}}'
                  </span>
               </h5>
            @else
               <h5>
                  <span style="float:left; ">
                     NIVEL: {{$conf['curso'].' '.$conf['titulo'].' EN '.$conf['esp_descripcion_general']}}
                  </span>
                  <span style="float:right; ">
                     Paralelo:'{{$conf['paralelo']}}'
                  </span>
      ...
      @endif
                  ...
                  <tr>
                    ...
                    @foreach($materias as $m)
                      <?php
                      //$clsWidth=0;
                      strlen($m->mtr_descripcion)<50?$clsWidth=25:$clsWidth=50;
                      ?>
                      <th class="materias" style="width:{{$clsWidth.'px'}}" ><span>{{$m->mtr_descripcion}}</span></th>
                    @endforeach

                    @if($cur<4)
                    <th class="materias" style="width:30px; " ><span> PROYECTOS EDUCATIVOS </span></th>
                    @endif
                    <th class="materias" style="width:25px;" ><span> Promedio </span></th>
                    <th class="materias" style="width:25px;" ><span>Comportamiento </span></th>
                    <th class="materias" style="width:25px;" ><span>Observaciones </span></th>
                  </tr>
                  <?php
                    $x=1;
                    $prm80=0;
                  ...
                  <tr>
                    ...
                    <?php $prm_est=0; $prm_disc_mat="";?>
                        ...
                        <?php
                            ...
                            //OJO ESTE CODIGO HAY QUE MODIFICAR
...
@else
    ...
    <br>
    <br>
    <span style="font-weight:bolder; ">RECTOR</span> <span style="margin-left:45%;font-weight:bolder; ">SECRETARIA</span>
@endif
