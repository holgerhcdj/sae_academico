                <table class="table table-hover" id="tbl_datos" style="width:auto; ">
                    ...
                    <tr>
                      <th class="" colspan="{{(count($materias)*6)+2}}">REPORTE DE NOTAS POR FIGURA PROFESIONAL 1ER QUIMESTRE</th>
                    </tr>
                    <tr>
                  ...
                  <colgroup>
                    ...
                    <?php $x=1;$clsh=""; ?>
                          ...
                          <col>
                          <col>
                          <col style="background:#bee3ef ">
                          @endforeach
                  </colgroup>
                  <tr>
                    <th colspan="2">Estudiante</th>
                    @foreach($materias as $m)
                        <th colspan="4" class="text-center cls_materias" data="{{$m->mtr_id}}" >{{$m->mtr_descripcion}}</th>
                    @endforeach
                    <th>PROM</th>
                  ...
                  <tr>
                    ...
                    <?php $prm_est=0; $prm_disc_mat="";?>
                        ...
                        <?php
                            ...
                            $prom_c=calcula_comportamiento_q1($cb1,$cb2,'A');
                            $prm_est+=$prfq1;
                            $prm_disc_mat.=$prom_c;

                        ?>
                        <td class="{{$cls_p1}}" >{{$nt_p1}}</td>
                        <td class="{{$cls_p2}}" >{{$nt_p2}}</td>
                        <td class="{{$cls_q1}}" >{{$ex_q1}}</td>
                        <td class="{{$cls_prfq1}}"  >
                          <span class="btn_prom {{'prom'.$m->mtr_id}}" est="{{$dt_est[0].' / '.$m->mtr_descripcion}}" mat_id="{{$dt_est[1]}}" mtr_id="{{$m->mtr_id}}" p1="{{$nt_p1}}" p2="{{$nt_p2}}" exq1="{{$ex_q1}}" prmq1="{{$prfq1}}" >
                              {{$prfq1}}
                          </span>
                        </td>
                        @endforeach
                        ...
                        <?php
                            ...
                            $prom_cinsp=calcula_comportamiento_q1($cb1,$cb2,'A');
                        ?>
                        <td>{{$prom_cinsp}}</td>
                  </tr>
                  @endforeach
