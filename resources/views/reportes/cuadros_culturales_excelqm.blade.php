...
$tx_esp=$dt_enc_xls['esp'];
if($tx_esp=='BGU'){
   $tx_esp="DE BACHILLERATO GENERAL UNIFICADO";
}
...
<img src="http://181.211.10.10/img/logo_mineduc.png" alt="logo mineduc" >
                ...
                <table>
                    ...
                    <tr>
                      @if($qm=='Q1')
                          <th class="" colspan="{{(count($materias))+2}}">CUADROS DEL 1ER QUIMESTRE</th>
                      @elseif($qm=='Q2')
                          <th class="" colspan="{{(count($materias))+2}}">CUADROS DEL 2DO QUIMESTRE</th>
                      @else
                          <th class="" colspan="{{(count($materias))+2}}">CUADROS DEL FINALES</th>
                      @endif                      
                    </tr>
                    <tr>
                      <th>NIVEL:</th>
                      <th colspan="10" style="text-align:left;">{{$dt_enc_xls['cur'].' '.$tx_esp }}</th>
                    </tr>
                    <tr>
                      <th>JORNADA:</th>
