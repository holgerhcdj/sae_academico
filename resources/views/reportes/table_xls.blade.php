...
<table  id="matutina" >
        <thead>
            ...
            <tr>
                <th></th>
                <th colspan="4" class="basica">BASICA REGULAR</th>
                <th colspan="4">BACHILLERATO TÉCNICO</th>
                <th></th>
            </tr>
            <tr>
                <th>ESPECIALIDADES</th>
                <th class="basica">8vo</th>
                <th class="basica">9no</th>
                <th class="basica">10mo</th>
                <th class="basica">Total</th>
                <th>1ro</th>
                <th>2do</th>
                <th>3ro</th>
                <th>Total</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="basica">{{$r->octavo}}</td>
                <td class="basica">{{$r->noveno}}</td>
                <td class="basica">{{$r->decimo}}</td>
                <td class="basica">{{$t_basico}}</td>
                <td>{{$r->primero}}</td>
                <td>{{$r->segundo}}</td>
                <td>{{$r->tercero}}</td>
        ...
        <tfoot>
            <tr class="final">
                <td class="">Totales</td>
                <td class="basica">{{$t8}}</td>
                <td class="basica">{{$t9}}</td>
                <td class="basica">{{$t10}}</td>
                <td class="basica">{{$t_basicog}}</td>
...
<table  id="retirados">
        <thead>
            <tr>
                <th colspan="8" style="text-align:center" >RETIRADOS</th>
            </tr>
            <tr>
                <th>ESPECIALIDADES</th>
                <th>8vo</th>
...
<table  id="nocturna">
        <thead>
            ...
            <tr>
                <th></th>
                <th colspan="4">BÁSICA INTENSIVA</th>
...
<table  id="Totales" >
        <thead>
            <tr>
                <th colspan="4" style="text-align:center;">TOTALES MATRICULADOS</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="total" style="font-weight:bolder; font-size:18px;  ">{{($t_gegm+$t_gegn+$t_gegd)}}</td>
                <td class="total" style="font-weight:bolder; ">{{$tgm+$tgn+$tgd}}</td>
                <?php $totros=0;?>
                @foreach($otros as $o)
                <?php
                $totros+=$o->cant;
